...
public class LambdaFunctionHandler implements RequestHandler<TokenAuthorizer, AuthPolicy> {


        @Override
        public AuthPolicy handleRequest(TokenAuthorizer input, Context context) {
        	
        	context.getLogger().log("Beginning  : "+input + "context "+ context);
